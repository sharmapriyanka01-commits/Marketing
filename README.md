...
- `web/index.html` that displays customer records, includes a **Show qualified leads for upgrade** button, and now includes a task management panel that auto-detects tasks from one document + one chat conversation and shows a prioritized Marketing team task list.
